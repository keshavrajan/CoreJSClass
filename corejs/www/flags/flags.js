...
(function() { // Keep this line.
	...
	//bucket.insert(flag2);
	var flag2 = document.querySelector("#articles > article:nth-child(1) > p:nth-child(3) > a > span");
	bucket.insert(flag2);


	var flag3 = document.querySelector("#articles > div > div > div > div:nth-child(2) > div:nth-child(1)");
	bucket.insert(flag3);

	var flag4 = document.querySelector("#article-3 > p:nth-child(4) > span");
	bucket.insert(flag4);

	var flag5 = document.querySelector("#article-3 > p:nth-child(4)");
	bucket.insert(flag5);
